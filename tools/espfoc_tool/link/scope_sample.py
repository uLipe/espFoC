...
``python -m espfoc_tool.gui --scope-csv`` so comma-separated float lines
...
_ENV_CSV = "ESPFOC_TOOL_SCOPE_CSV"
_ENV_CSV_LEGACY = "ESP_FOC_STUDIO_SCOPE_CSV"
...
def legacy_csv_decoding_enabled() -> bool:
    return (os.environ.get(_ENV_CSV, "0") == "1"
            or os.environ.get(_ENV_CSV_LEGACY, "0") == "1")
