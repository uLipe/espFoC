...
#define CONFIG_NOOF_AXIS 1
#define CONFIG_FOC_TASK_STACK_SIZE 3072
#define CONFIG_ESP_FOC_CUSTOM_MATH 1
#define CONFIG_ESP_FOC_SCOPE_NUM_CHANNELS 8
#define CONFIG_ESP_FOC_SCOPE_BUFFER_SIZE 4096
#define CONFIG_ESP_FOC_USE_SPACE_VECTOR_PWM 1
