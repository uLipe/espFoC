 ...
 * @brief Space-vector PWM (SVPWM) in Q16.16: alpha/beta to three-phase duties [0,1].
 */
#pragma once
                                   ...
                                   q16_t *duty_c)
{
    ...
    q16_t v_a = v_alpha;
    q16_t v_b = q16_add(neg_half_alpha, sqrt3_beta);
    q16_t v_c = q16_sub(neg_half_alpha, sqrt3_beta);
